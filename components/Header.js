	...
	return (
		<header>
			...
			flex-grow py-2">
				...
				rounded-md flex-grow cursor-pointer bg-yellow-400 
				hover:bg-yellow-500"> 
					<input 
				...
				{/*Right*/}
				<div className="flex text-white items-center text-xs space-x-6
				mx-6 whitespace-nowrap">
					...
					<div onClick={()=>router.push("/checkout")} className="relative flex items-center cursor-pointer link">
						...
						h-4 w-4 bg-yellow-400 text-center rounded-full text-black
						font-bold">
							{items.length}
						</span>
